...
func TestShowSnippet(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid ID", "/snippet/1", http.StatusOK, []byte("An old silent fart...")},
...
func TestSignupUser(t *testing.T) {
	...
	tests := []struct {
		...
		{"Duplicate email", "Bob", "duplicate@test.com", "validPa$$word", csrfToken, http.StatusOK, []byte("Address is already in use")},
